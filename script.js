...
if(welcome){
  ...
  const build=document.createElement('section');build.className='build-strip reveal';build.setAttribute('aria-label','Build snapshot');build.innerHTML='<article class="build-card" style="--progress:82%"><strong>Build</strong><small>Portfolio + practical web projects</small></article><article class="build-card" style="--progress:68%"><strong>Learn</strong><small>C, JavaScript, Git & core CS</small></article><article class="build-card" style="--progress:74%"><strong>Improve</strong><small>UI, performance, security & UX</small></article>';

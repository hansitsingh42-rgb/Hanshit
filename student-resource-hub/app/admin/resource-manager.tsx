...
type Subject = { id: string; name: string; slug: string; chapters: Chapter[] };
type Chapter = { id: string; name: string; slug: string; subjectId?: string; subject?: { id: string; name: string } };
type Resource = {
  id: string;
  title: string;
  slug: string;
